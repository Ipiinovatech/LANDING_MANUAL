  ...
  const getDetailedDescription = (productTitle: string) => {
    const descriptions: { [key: string]: { es: string; en: string } } = {
      ...
      "Virtual Smart Video": {
        ...
        en: "Virtual Smart Video is the innovative platform that transforms interviews and training through artificial intelligence, optimizing processes and reducing operational costs. With advanced capabilities such as emotion recognition and biophysical profiling, this tool available 24 hours a day, 7 days a week ensures real-time analysis, providing valuable insights. Additionally, its secure information storage guarantees confidentiality. Optimize interviews, train your team, and take your company's efficiency to the next level with Virtual Smart Video. Start today!"
      },
      ...
      "Virtual IPV": {
        es: "VIRTUAL IPV es la solución integral para gestionar actividades en los puntos de venta, diseñada para optimizar las estrategias retail en grandes superficies y pequeñas tiendas. Con dos modos de ejecución, esta plataforma permite gestionar tareas como merchandising, promociones y análisis de competencia de manera eficiente. Su registro fotográfico georreferenciado y módulo móvil brindan la capacidad de tomar decisiones informadas al instante, transformando la gestión en los puntos de venta y fomentando la lealtad de los clientes. Con VIRTUAL IPV, eleva su negocio y trans forma su estrategia retail.",
